...
const HERO_SLIDES = [
  ...
  {
    headline: "Mughal Artisan Legacy",
    subheadline:
      "Chikankari embroidery, zardozi goldwork, and Lucknawi tehzeeb",
    tagline: "ہندوستان کی روح",
    taglineLang: "Urdu",
    medallion: "Chikankari",
    gradient: "from-[#2A1A00] via-[#4A3000] to-[#7A5000]",
    accent: "#C09040",
  },
  {
